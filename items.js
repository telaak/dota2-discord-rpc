items = {
  "itemdata": {
    ...
    "javelin": {
      ...
      "qual": "component",
      "cost": 1100,
      "desc": "<h1>Passive: Pierce</h1>Grants each attack a 25% chance to pierce through evasion and deal 100 bonus magical damage.",
      "notes": "",
      "attrib": "",
      "mc": false,
      "cd": false,
    ...
    "faerie_fire": {
      ...
      "qual": "consumable",
      "cost": 70,
      "desc": "<h1>Use: Imbue</h1> Instantly restores 85 health.",
      "notes": "",
    ...
    "stout_shield": {
      ...
      "qual": "component",
      "cost": 200,
      "desc": "<h1>Passive: Damage Block</h1>Grants a 50% chance to block 20 damage from incoming attacks on melee heroes, and 9 damage on ranged.",
    ...
    "moon_shard": {
      ...
      "qual": "consumable",
      "cost": 4000,
      "desc": "<h1>Use: Consume</h1> Consume the Moon Shard to permanently gain 60 attack speed and 200 bonus night vision. Max 1 use.<br />\r\n<h1>Passive: Shade Sight</h1>Grants 400 bonus night vision.",
    ...
    "magic_wand": {
      ...
      "qual": "common",
      "cost": 450,
      "desc": "<h1>Active: Energy Charge</h1>Instantly restores 15 health and mana per charge stored. <br><br>Max 20 charges. Gains a charge whenever a visible enemy within 1200 range uses an ability.",
      "notes": "Gains charges for spells cast by visible enemies in 1200 range.<br />Certain abilities and item abilities will not add charges.",
    ...
    "enchanted_mango": {
      ...
      "qual": "consumable",
      "cost": 70,
      "desc": "<h1>Use: Eat Mango</h1> Instantly restores 125 mana.<br><br>Range: 400",
      "notes": "Hold Control to use on a nearby allied hero.",
      "attrib": "+ <span class=\"attribVal\">0.5</span> <span class=\"attribValText\">HP Regeneration</span>",
      "mc": false,
      "cd": false,
    ...
    "bottle": {
      ...
      "qual": "common",
      "cost": 650,
      "desc": "<h1>Active: Regenerate</h1>Consumes a charge to restore 100 health and 50 mana over 2.5 seconds. If the hero is attacked by an enemy hero or Roshan, the effect is lost.<br><br>The Bottle automatically refills at the fountain.<br><br>Hold Control to use on an allied hero.<br><br>Range: 350<br />\r\n<h1>Passive:  Store Rune</h1>Runes can be stored in the bottle for later use by right-clicking them. Unused runes will automatically activate after 2 minutes.<br><br>Using a stored rune fully refills the Bottle. Stored Bounty Runes replenish 2/3 charges.",
    ...
    "ward_sentry": {
      ...
      "qual": "consumable",
      "cost": 100,
      "desc": "<h1>Use: Plant</h1> Plants a Sentry Ward, an invisible watcher that grants True Sight, the ability to see invisible enemy units and wards, to any existing allied vision within a 850 radius.<br>Lasts 6 minutes.<br><br>Does not grant ground vision.<br>Hold Control to give one Sentry Ward to an allied hero.<br><br>Range: 500",
      "notes": "",
      "attrib": "",
      "mc": false,
      "cd": 1,
    ...
    "tango": {
      ...
      "qual": "consumable",
      "cost": 90,
      "desc": "<h1>Use: Devour</h1> Consumes a target tree to gain 7 health regeneration for 16 seconds. Consuming a ward or Ironwood Tree doubles the heal amount.<br><br>Comes with 3 charges.  Can be used on an allied hero to give them one Tango.<br><br>Range: 165<br>Ward Range: 450",
      "notes": "",
      "attrib": "",
      "mc": false,
      "cd": false,
    ...
    "tango_single": {
      ...
      "qual": "consumable",
      "cost": 30,
      "desc": "<h1>Use: Devour</h1> Consumes a target tree to gain 7 health regeneration for 16 seconds. Consuming a ward or Ironwood Tree doubles the heal amount.<br><br>Range: 165<br>Ward Range: 450",
      "notes": "",
      "attrib": "",
      "mc": false,
      "cd": 60,
    ...
    "travel_boots": {
      ...
      "qual": "common",
      "cost": 2500,
      "desc": "<h1>Active: Teleport</h1>Teleports you to an allied non-hero unit or structure. Teleporting to a unit is interrupted if the target unit dies.<br><br>Shares a cooldown with Town Portal Scroll.<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.",
      "notes": "",
    ...
    "travel_boots_2": {
      ...
      "qual": "common",
      "cost": 4500,
      "desc": "<h1>Active: Teleport</h1> Teleports you to any allied structure or unit, including heroes. Teleporting to a unit is interrupted if the target unit dies.<br><br>Shares a cooldown with Town Portal Scroll.<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.",
      "notes": "",
      "attrib": "+ <span class=\"attribVal\">100</span> <span class=\"attribValText\">Movement Speed</span>",
      "mc": 75,
      "cd": 45,
    ...
    "phase_boots": {
      ...
      "qual": "common",
      "cost": 1360,
      "desc": "<h1>Active: Phase</h1> Gives 20% increased movement speed on melee heroes, and 13% on ranged heroes, and lets you move through units and turn more quickly for 3 seconds.<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.",
      "notes": "",
    ...
    "power_treads": {
      ...
      "qual": "common",
      "cost": 1450,
      "desc": "<h1>Active: Switch Attribute</h1>Switches between +10 Strength, +10 Agility, or +10 Intelligence.<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.",
    ...
    "poor_mans_shield": {
      ...
      "qual": "common",
      "cost": 0,
      "desc": "<h1>Passive: Damage Block</h1>When cooldown is ready, blocks 30 damage on melee heroes and 15 on ranged heroes. Only triggers on attacks from heroes. <br><br>Gives a 50% chance to block 18 damage from incoming attacks on melee heroes, and 9 damage on ranged.",
      "notes": "Multiple sources of damage block do not stack.",
      "attrib": "+ <span class=\"attribVal\">6</span> <span class=\"attribValText\">Agility</span>",
      "mc": false,
      "cd": 25,
    ...
    "mekansm": {
      ...
      "qual": "rare",
      "cost": 2350,
      "desc": "<h1>Active: Restore</h1>Heals 275 health and gives +2 armor to allied units in a 900 radius.<br />\r\n<h1>Passive: Mekansm Aura</h1>Grants 3.5 health regeneration to allied units in a 900 radius.",
    ...
    "vladmir": {
      ...
      "qual": "rare",
      "cost": 2250,
      "desc": "<h1>Passive: Vladmir's Aura</h1>Grants lifesteal (15% for melee heroes, 10% for ranged), 2.5 health regeneration, 1 mana regeneration, 15% bonus attack damage, and 4 armor to nearby allies. <br><br>Radius: 900",
    ...
    "urn_of_shadows": {
      ...
      "qual": "rare",
      "cost": 875,
      "desc": "<h1>Active: Soul Release</h1> Provides 30 health regeneration when cast on allies, and deals 25 damage per second when cast on enemies. <br><br>Lasts 8 seconds.  <br><br>Gains charges every time an enemy hero dies within 1400 units.  Only the closest Urn to the dying hero will gain a charge.<br><br>Cast Range: 950",
    ...
    "echo_sabre": {
      ...
      "qual": "artifact",
      "cost": 2650,
      "desc": "<h1>Passive: Echo Strike</h1> Causes melee attacks to attack twice in quick succession. The double attacks apply a 100% movement slow for 0.8 seconds on each strike.",
      "notes": "",
    ...
    "dagon": {
      ...
      "qual": "rare",
      "cost": 2715,
      "desc": "<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Upgradable.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 120",
    ...
    "dagon_2": {
      ...
      "qual": "rare",
      "cost": 3965,
      "desc": "<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Upgradable.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 140",
      "notes": "Instantly kills illusions.",
    ...
    "dagon_3": {
      ...
      "qual": "rare",
      "cost": 5215,
      "desc": "<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Upgradable.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 160",
      "notes": "Instantly kills illusions.",
    ...
    "dagon_5": {
      ...
      "qual": "rare",
      "cost": 7715,
      "desc": "<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 200",
      "notes": "Instantly kills illusions.",
    ...
    "black_king_bar": {
      ...
      "qual": "epic",
      "cost": 3975,
      "desc": "<h1>Active: Avatar</h1> Grants Spell Immunity and 100% Magic Damage Resistance.  Duration decreases with each use. <br><br>Duration: 10 <br>Dispel Type: <span class=\"GameplayValues GameplayVariable\">Basic Dispel</span>",
    ...
    "nullifier": {
      ...
      "qual": "epic",
      "cost": 4700,
      "desc": "<h1>Active: Nullify</h1> Dispels the target and mutes them for 5 seconds. Anytime the muted target is attacked, it will be slowed by 100% for 0.4 seconds.<br><br>Dispel Type: <span class=\"GameplayValues GameplayVariable\">Basic Dispel</span>",
      "notes": "",
    ...
    "aeon_disk": {
      ...
      "qual": "epic",
      "cost": 3350,
      "desc": "<h1>Passive: Combo Breaker</h1> When you take damage and your health falls below 70%, a strong dispel is applied and you gain a 2.5 second buff that causes all damage you deal and are dealt to be reduced to zero. Only triggers on player based damage.",
      "notes": "",
      "attrib": "+ <span class=\"attribVal\">250</span> <span class=\"attribValText\">Health</span><br />\n+ <span class=\"attribVal\">250</span> <span class=\"attribValText\">Mana</span><br />\n+Status Resistance <span class=\"attribVal\">25%</span>",
      "mc": false,
      "cd": 115,
    ...
    "monkey_king_bar": {
      ...
      "qual": "epic",
      "cost": 4175,
      "desc": "<h1>Passive: Pierce</h1>Grants each attack a 75% chance to pierce through evasion and deal 100 bonus magical damage.",
      "notes": "",
    ...
    "radiance": {
      ...
      "qual": "epic",
      "cost": 5150,
      "desc": "<h1>Toggle: Burn</h1> When active, scorches enemies for 60 magical damage per second, and causes them to miss 17% of their attacks. Illusions deal 35 magical damage per second.<br><br>Radius: 700",
      "notes": "",
    ...
    "basher": {
      ...
      "qual": "epic",
      "cost": 3050,
      "desc": "<h1>Passive: Bash</h1> Grants melee heroes a 25% chance on hit to stun the target for 1.5 seconds and deal 100 bonus magical damage.  Bash chance for ranged heroes is 10%.",
    ...
    "invis_sword": {
      ...
      "qual": "epic",
      "cost": 2800,
      "desc": "<h1>Active: Shadow Walk</h1>Makes you invisible for 14 seconds, or until you attack or cast a spell.  While Shadow Walk is active, you move 20% faster and can move through units.  <br><br>If attacking to end the invisibility, you gain 175 bonus physical damage on that attack.",
    ...
    "silver_edge": {
      ...
      "qual": "epic",
      "cost": 5550,
      "desc": "<h1>Active: Shadow Walk</h1>Makes you invisible for 14 seconds, or until you attack or cast a spell.  While invisible, you move 25% faster and can move through units.  <br><br>Attacking to end the invisibility will deal 175 bonus physical damage to the target, and for 4 seconds, disable their passive abilities.",
    ...
    "sange_and_yasha": {
      ...
      "qual": "artifact",
      "cost": 4300,
      "desc": "<h1>Passive: Maim</h1>Each attack has a 40% chance to reduce enemy hero movement speed by 26% and attack speed by 26 when used by a melee hero. Reduces enemy hero movement by 13% and attack speed by 13 when used by a ranged hero. Effect lasts 5 seconds.",
    ...
    "mjollnir": {
      ...
      "qual": "artifact",
      "cost": 5600,
      "desc": "<h1>Active: Static Charge</h1>Places a charged shield on a target unit for 15 seconds which has a 20% chance to release a 200 magical damage shocking bolt at a nearby attacker and 4 additional enemies.<br><br>Range: 800<br />\r\n<h1>Passive: Chain Lightning</h1>Grants a 25% chance on attack to release a bolt of electricity that leaps between 12 targets within a 900 radius, dealing 170 magical damage to each. Lightning proc pierces evasion.",
    ...
    "maelstrom": {
      ...
      "qual": "artifact",
      "cost": 2700,
      "desc": "<h1>Passive: Chain Lightning</h1>Grants a 25% chance on attack to release a bolt of electricity that leaps between 4 targets within a 900 radius, dealing 160 magical damage to each. Lightning proc pierces evasion.",
      "notes": "",
      "attrib": "+ <span class=\"attribVal\">24</span> <span class=\"attribValText\">Damage</span>",
      "mc": false,
      "cd": false,
    ...
    "arcane_boots": {
      ...
      "qual": "rare",
      "cost": 1400,
      "desc": "<h1>Active: Replenish Mana</h1>Restores 135 mana to all nearby allies.<br><br>Radius: 900<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.",
    ...
    "orb_of_venom": {
      ...
      "qual": "component",
      "cost": 275,
      "desc": "<h1>Passive: Poison Attack</h1>Poisons the target, dealing 5 magical damage per second and slowing movement by 12% if the equipped hero is melee, or 3 magical damage per second and slowing movement by 4% if they are ranged. Lasts for 3 seconds.",
      "notes": "",
      "attrib": "",
      "mc": false,
      "cd": false,
    ...
    "solar_crest": {
      ...
      "notes": "",
      "attrib": "+ <span class=\"attribVal\">10</span> <span class=\"attribValText\">Armor</span><br />\n+ <span class=\"attribVal\">1</span> <span class=\"attribValText\">Mana Regeneration</span><br />\n+ <span class=\"attribVal\">15%</span> <span class=\"attribValText\">Evasion</span>",
      "mc": false,
      "cd": 7,
    ...
    "guardian_greaves": {
      ...
      "qual": "rare",
      "cost": 5450,
      "desc": "<h1>Active: Mend</h1>Restores 275 health and 160 mana to nearby allies, and removes most negative effects from the caster.<br><br>Radius: 900<br>Dispel Type: <span class=\"GameplayValues GameplayVariable\">Basic Dispel</span><br />\r\n<h1>Passive: Guardian Aura</h1> Provides nearby allies with 3.5 health regeneration and 2 bonus armor. If an allied hero's health falls below 20%, they receive 12 health regeneration and 15 armor.<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.",
    ...
    "heavens_halberd": {
      ...
      "qual": "artifact",
      "cost": 3550,
      "desc": "<h1>Active: Disarm</h1>Prevents a target from attacking for 3 seconds on melee targets, and 5 seconds on ranged targets.<br><br>Range: 600 <br />\r\n<h1>Passive: Maim</h1>Each attack has a 40% chance to reduce enemy hero movement speed by 26% and attack speed by 26 if the user is melee. Reduces enemy hero movement by 13% and attack speed by 13 if the user is ranged. Effect lasts 5 seconds.",
      "notes": "",
    ...
    "tranquil_boots": {
      ...
      "qual": "rare",
      "cost": 1050,
      "desc": "<h1>Passive: Break</h1> Whenever you attack or are attacked, the bonus 13 HP regen is lost and the movement speed bonus is reduced to 65 for 13 seconds.<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.",
      "notes": "",
    ...
    "shadow_amulet": {
      ...
      "qual": false,
      "cost": 1400,
      "desc": "<h1>Active: Fade</h1>Grants invisibility to you or a target allied hero as long as the target unit remains still.  <br><br>Has a 1.25 second fade time, and breaks instantly upon moving. <br><br>There is no cooldown when using this item on yourself.<br><br>Range: 600",
      "notes": "",
      "attrib": "+ <span class=\"attribVal\">20</span> <span class=\"attribValText\">Attack Speed</span>",
      "mc": false,
      "cd": 7,
    ...
    "mutation_tombstone": {
      "id": 1028,
      "img": "mutation_tombstone_lg.png?3",
      "dname": "Tombstone",
      "qual": "consumable",
      "cost": 0,
      "desc": "",
    ...
    "super_blink": {
      "id": 1029,
      "img": "super_blink_lg.png?3",
      "dname": "Super Blink Dagger",
      "qual": false,
      "cost": null,
      "desc": "<h1>Active: Blink</h1> Teleport to a target point up to 1200 units away.",
      "notes": "",
      "attrib": "",
      "mc": false,
      "cd": 15,
